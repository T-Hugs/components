...
export interface AnchoredPositionHookSettings extends PositionSettings {
 ...
 * floating element.
 */
export function useAnchoredPosition(settings: AnchoredPositionHookSettings, dependencies: React.DependencyList) {
